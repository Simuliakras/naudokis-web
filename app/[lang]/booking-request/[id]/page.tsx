...
export default async function Page({ params }: PageProps<"/[lang]/booking-request/[id]">) {
  const { lang, id } = await params;
  requireLocale(lang);
  return <AppHandoffScreen kind="bookingRequest" appPath={`/booking-request/${encodeURIComponent(id)}`} />;
}
