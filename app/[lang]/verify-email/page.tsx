...
// The web has no login, so this explains where the thing lives — see app/lib/app-links.ts.
...
export default async function Page({ params }: PageProps<"/[lang]/verify-email">) {
  const { lang } = await params;
  requireLocale(lang);
  return <AppHandoffScreen kind="verifyEmail" appPath="/verify-email" sensitiveQuery />;
}
